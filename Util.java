...
public class Util
{
	...
	**********************************************************/
	...
	//set left that receives an int
	public static String setLeft(int num, int word)
	{
		//local constants
        ...
        return setLeft(num, word + "");
	}
	//set left that receives a float
	public static String setLeft(int num, float word)
	{
		//local constants
	...
	//set left that receives a double
	public static String setLeft(int num, double word)
	{
		//local constants
	...
	**********************************************************/
	...
	//set right that receives an int
	public static String setRight(int num, int word)
	{
		//local constants
        ...
        return setRight(num, word + "");
	}
	//set right that receives a float
	public static String setRight (int num, float word)
	{
		//local constants
	...
	//set left that receives a double
	public static String setRight(int num, double word)
	{
		//local constants
